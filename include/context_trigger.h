 ...
 * @since_tizen 2.4
 *
 * @remarks		When making a rule with @c entry, regarding the @c event_item of the entry,
 *				the application may require one of the following privileges:@n
 ...
 *				If the application does not have necessary privileges,
 *				context_trigger_add_rule() will return #CONTEXT_TRIGGER_ERROR_PERMISSION_DENIED.
 *				See #context_trigger_event_e to find the corresponding privilege.@n
 ...
 * @since_tizen 2.4
 *
 * @remarks		When making a rule with @c entry, regarding the @c condition_item of the entry,
 *				the application may require one of the following privileges:@n
 *				http://tizen.org/privilege/network.get @n
 *				http://tizen.org/privilege/telephony @n
 ...
 *				If the application does not have necessary privileges,
 *				context_trigger_add_rule() will return #CONTEXT_TRIGGER_ERROR_PERMISSION_DENIED.
 *				See #context_trigger_condition_e to find the corresponding privilege.@n
 *				The @c entry must be released using context_trigger_rule_entry_destroy().
 *
